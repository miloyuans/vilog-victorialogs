...
const state = {
  ...
  bindingEditingId: "",
  ui: {
    navCollapsed: localStorage.getItem(storageKeys.navCollapsed) == null ? true : localStorage.getItem(storageKeys.navCollapsed) === "true",
    railCollapsed: localStorage.getItem(storageKeys.railCollapsed) == null ? true : localStorage.getItem(storageKeys.railCollapsed) === "true",
    detailOpen: false,
    openMenu: "",
  },
  search: {
...
function stripRuntimeFields(item) { const clone = { ...item }; delete clone._index; delete clone._level; delete clone.search_text; return clone; }
